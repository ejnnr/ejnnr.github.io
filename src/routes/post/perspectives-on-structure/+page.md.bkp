...
summary = """
  ...
  """
date = 2020-12-29T14:03:00+01:00
tags = ["Structure", "Math"]
draft = false
[image]
  preview_only = "true"
...
## Structure can be canonically removed {#structure-can-be-canonically-removed}
...
and ignoring the metric itself (category theory footnote[^fn:1]).


## Structure leads to smaller symmetry groups {#structure-leads-to-smaller-symmetry-groups}

If \\(\mathcal{A} \prec \mathcal{B}\\), then the automorphism group[^fn:2] of \\(A \in \mathcal{A}\\)
...
## More structure leads to fewer structure-preserving maps {#more-structure-leads-to-fewer-structure-preserving-maps}
...
## Structure allows more definitions and theorems {#structure-allows-more-definitions-and-theorems}
...
## Inherent structure of objects {#inherent-structure-of-objects}
